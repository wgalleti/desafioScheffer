...
<template>
  <main class="grid grid-cols-12 mt-6 p-2 gap-3">
    <div class="col-span-2 border rounded-lg p-2">
      <h1 class="text-3xl font-thin text-center my-2 text-primary-950">Algodoeiras</h1>
      <ul class="my-2">
        <li
        ...
        >
          <div class="flex justify-between">
            ...
            <p class="text-primary-950 font-thin tracking-tighter">{{ algodoeira.producao }}</p>
          </div>
        </li>
      </ul>

      <h1 class="text-3xl font-thin text-center my-2 text-primary-950">Fazendas</h1>
      <ul class="my-2 p-2">
        <li
        ...
        >
          <div class="flex justify-between flex flex-col">
            <h2>{{ fazenda.nome }}</h2>
            <div class="text-primary-950 font-thin tracking-tighter flex justify-between px-1">
              <p>{{ fazenda.rolinhos }}<span class="text-xs"> Rolinhos</span></p>
